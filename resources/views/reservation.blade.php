	...
	-->
                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form action="{{url('reservation')}}" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
                              ...
                              <div class="col-md-6 col-sm-6">
                                   <input type="number" class="form-control" id="cf-phone" name="phone" placeholder="Phone Number" required>
                              </div>

                              <div class="col-md-6 col-sm-6">
                                   <input type="Number" class="form-control" id="cf-guest" name="guest" placeholder="Number of Guest" required>
                              </div>
                              ...
                              <div class="col-md-6 col-sm-6">
                                   <input type="Time" class="form-control" id="cf-time" name="time" placeholder="Time" required>
                              </div>
